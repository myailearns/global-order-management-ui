...
export const FEATURE_TEMPLATES: FeatureTemplate[] = [
  ...
  { featureKey: 'stock.create', displayName: 'Create Stock Entry', module: 'product', dependencies: [], filters: [{ key: 'max_movements_per_month', defaultValue: 1000 }] },
  ...
  { featureKey: 'offer.create', displayName: 'Create Offer', module: 'offers', dependencies: [], filters: [{ key: 'max_count', defaultValue: 10 }] },
  ...
  { featureKey: 'dashboard.view', displayName: 'View Dashboard', module: 'tenant-admin', dependencies: [] },
  { featureKey: 'employees.view', displayName: 'View Accounts', module: 'tenant-admin', dependencies: [] },
  { featureKey: 'employees.add', displayName: 'Create Account', module: 'tenant-admin', dependencies: [], filters: [{ key: 'max_count', defaultValue: 10 }] },
  { featureKey: 'employees.edit', displayName: 'Edit Account', module: 'tenant-admin', dependencies: ['employees.view'] },
  { featureKey: 'employees.delete', displayName: 'Delete Account', module: 'tenant-admin', dependencies: ['employees.view'] },
  { featureKey: 'user.list', displayName: 'View Users', module: 'tenant-admin', dependencies: [] },
  { featureKey: 'user.view', displayName: 'View User', module: 'tenant-admin', dependencies: ['user.list'] },
  { featureKey: 'user.create', displayName: 'Create User', module: 'tenant-admin', dependencies: [], filters: [{ key: 'max_count', defaultValue: 100 }] },
  ...
  { featureKey: 'roles.view', displayName: 'View Roles', module: 'tenant-admin', dependencies: [] },
  { featureKey: 'roles.add', displayName: 'Create Role', module: 'tenant-admin', dependencies: [], filters: [{ key: 'max_count', defaultValue: 5 }] },
  { featureKey: 'roles.edit', displayName: 'Edit Role', module: 'tenant-admin', dependencies: ['roles.view'] },
  { featureKey: 'roles.delete', displayName: 'Delete Role', module: 'tenant-admin', dependencies: ['roles.view'] },
  { featureKey: 'storefront.share', displayName: 'Share Storefront', module: 'tenant-admin', dependencies: [] },
  { featureKey: 'config.view', displayName: 'View Configuration', module: 'settings', dependencies: [] },
  { featureKey: 'config.edit', displayName: 'Edit Configuration', module: 'settings', dependencies: ['config.view'] },
  ...
  { featureKey: 'whatsapp.configure', displayName: 'Configure WhatsApp', module: 'settings', dependencies: [] },
  ...
  { featureKey: 'media.upload', displayName: 'Custom Image Upload', module: 'media', dependencies: [], filters: [{ key: 'max_images', defaultValue: 10 }, { key: 'max_videos', defaultValue: 1 }] },
];
