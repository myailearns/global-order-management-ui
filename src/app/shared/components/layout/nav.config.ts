...
export const NAV_ICONS = {
  ...
  businessType: 'ri-store-3-line',
  businessCategories: 'ri-folder-3-line',
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Business Type', route: '/settings/business-types', icon: NAV_ICONS.businessType, translationKey: 'app.navigation.businessType', section: 'Settings', actor: 'platform', capability: 'platform-admin' },
  { label: 'Business Categories', route: '/settings/business-categories', icon: NAV_ICONS.businessCategories, translationKey: 'app.navigation.businessCategories', section: 'Settings', actor: 'platform', capability: 'platform-admin' },
